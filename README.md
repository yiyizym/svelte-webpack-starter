...
**base on https://github.com/baileyherbert/svelte-webpack-starter**

A starter template for [Svelte](https://svelte.dev) that comes preconfigured with Webpack 5, TypeScript, SCSS, Babel,
